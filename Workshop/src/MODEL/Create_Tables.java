...
public class Create_Tables {
	...
	public static void main(String args[]) {
		JOptionPane.showMessageDialog(null, "Create Tables with JDBC Programming");
		int choice = -1;
		do {
			choice = getChoice();
			if (choice != 0) {
...
// to get the database connection with mysql database(Exam bd="workshop_software_db") server with mysql-jdbc driver as a localhost
	public static Connection getConnection() {
		Connection con = null;
		String url = "jdbc:mysql://localhost:3306/";//localhost and default port 3306 for mysql
		String db = "workshop_software_db"; // your database name
		String driver = "com.mysql.jdbc.Driver"; // mysql jdbc driver
		String user = "root"; // mysql database user name
		String pass = "riaydh"; // mysql database password
		try {
...
/* sql syntex for workshop_table creation:
  CREATE TABLE workshop_table(
  W_ID int(11) NOT NULL DEFAULT '0',
  W_TITLE varchar(30) DEFAULT NULL,
  W_LECTURER varchar(30) DEFAULT NULL,
  W_PARTICIPANT int(11) DEFAULT NULL,
  W_PLACE varchar(30) DEFAULT NULL,
  W_CATEGORY varchar(60) DEFAULT NULL,
  W_DURATION double DEFAULT NULL,
  W_PRICE double DEFAULT NULL,
  W_DESCRIPTION text DEFAULT NULL,
  W_LITERATURE text DEFAULT NULL,
